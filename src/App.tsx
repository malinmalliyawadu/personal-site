  ...
  return (
    <>
      <div className="min-h-screen text-white max-w-screen-lg mx-auto flex flex-col md:justify-center p-6">
        ...
        <div className="carousel overflow-x-hidden md:overflow-x-visible relative -mx-6">
          <ul className="flex gap-6 items-end overflow-x-auto md:overflow-visible px-6">
